...
static void
gldarmelf_linux_eabi_set_symbols (void)
{
...
gldarmelf_linux_eabi_after_open (void)
{
  ldelf_after_open (true, false,
		    true, false, 32, "/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host");
}
...
OUTPUT_ARCH(arm)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/arm-buildroot-linux-gnueabi/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
...
struct ld_emulation_xfer_struct ld_armelf_linux_eabi_emulation =
{
  ...
  ldelf_place_orphan,
  gldarmelf_linux_eabi_set_symbols,
  NULL,
  gldarmelf_linux_eabi_add_options,

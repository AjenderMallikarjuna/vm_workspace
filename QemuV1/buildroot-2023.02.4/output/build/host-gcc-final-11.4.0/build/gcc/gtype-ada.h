...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_ada_h[] = {
  {
    &gnat_raise_decls_ext[0],
    1 * ((int) LAST_REASON_CODE + 1),
    sizeof (gnat_raise_decls_ext[0]),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
...
extern const struct ggc_root_tab gt_ggc_r_gt_ada_misc_h[];
...
extern void gt_clear_caches_gt_ada_decl_h ();
extern void gt_clear_caches_gt_ada_utils_h ();
void
gt_clear_caches ()
{
  ...
  gt_clear_caches_gt_ada_utils_h ();
}
...
extern const struct ggc_root_tab gt_pch_rs_gt_ada_trans_h[];

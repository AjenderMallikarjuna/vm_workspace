...
gt_ggc_mx_machine_function (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_7rtx_def ((*x).eh_epilogue_sp_ofs);
      gt_ggc_m_7rtx_def ((*x).pic_reg);
      {
        size_t i0;
        size_t l0 = (size_t)(14);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_7rtx_def ((*x).call_via[i0]);
        }
      }
      gt_ggc_m_7rtx_def ((*x).thumb1_cc_insn);
      gt_ggc_m_7rtx_def ((*x).thumb1_cc_op0);
      gt_ggc_m_7rtx_def ((*x).thumb1_cc_op1);
    }
}
...
{
  function_summary<thunk_info*> * const x = (function_summary<thunk_info*> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_36vec_ipa_param_performed_split_va_gc_ ((*x).performed_splits);
    }
}
...
{
  function_summary<clone_info*> * const x = (function_summary<clone_info*> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
{
  modref_tree<alias_set_type> * const x = (modref_tree<alias_set_type> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
{
  vec<ipa_freqcounting_predicate,va_gc> * const x = (vec<ipa_freqcounting_predicate,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
gt_pch_nx_machine_function (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16machine_function))
    {
      gt_pch_n_7rtx_def ((*x).eh_epilogue_sp_ofs);
      gt_pch_n_7rtx_def ((*x).pic_reg);
      {
        size_t i0;
        size_t l0 = (size_t)(14);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_7rtx_def ((*x).call_via[i0]);
        }
      }
      gt_pch_n_7rtx_def ((*x).thumb1_cc_insn);
      gt_pch_n_7rtx_def ((*x).thumb1_cc_op0);
      gt_pch_n_7rtx_def ((*x).thumb1_cc_op1);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_10clone_info))
    {
      ...
      gt_pch_n_36vec_ipa_param_performed_split_va_gc_ ((*x).performed_splits);
    }
}
...
void
gt_pch_nx_vec_ipa_freqcounting_predicate_va_gc_ (void *x_p)
{
  vec<ipa_freqcounting_predicate,va_gc> * const x = (vec<ipa_freqcounting_predicate,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_37vec_ipa_freqcounting_predicate_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct ipa_freqcounting_predicate& x_r ATTRIBUTE_UNUSED)
{
  struct ipa_freqcounting_predicate * ATTRIBUTE_UNUSED x = &x_r;
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_flag_patchable_function_entry), cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).eh_epilogue_sp_ofs), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).pic_reg), cookie);
  {
    size_t i0;
    ...
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).call_via[i0]), cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).thumb1_cc_insn), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).thumb1_cc_op0), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).thumb1_cc_op1), cookie);
}
...
void
gt_pch_p_10thunk_info (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct thunk_info * x ATTRIBUTE_UNUSED = (struct thunk_info *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).alias), cookie);
}

void
gt_pch_p_29function_summary_thunk_info__ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct function_summary<thunk_info*> * x ATTRIBUTE_UNUSED = (struct function_summary<thunk_info*> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_p_10clone_info (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct clone_info * x ATTRIBUTE_UNUSED = (struct clone_info *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).tree_map), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).param_adjustments), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).performed_splits), cookie);
}

void
gt_pch_p_29function_summary_clone_info__ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct function_summary<clone_info*> * x ATTRIBUTE_UNUSED = (struct function_summary<clone_info*> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).m_thunks), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).m_clones), cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).conds), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).loop_iterations), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).loop_strides), cookie);
}
...
void
gt_pch_p_27modref_tree_alias_set_type_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct modref_tree<alias_set_type> * x ATTRIBUTE_UNUSED = (struct modref_tree<alias_set_type> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_p_14modref_summary (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct modref_summary * x ATTRIBUTE_UNUSED = (struct modref_summary *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).loads), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).stores), cookie);
...
void
gt_pch_p_12int_range_1_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
void
gt_pch_p_37vec_ipa_freqcounting_predicate_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<ipa_freqcounting_predicate,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<ipa_freqcounting_predicate,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct ipa_freqcounting_predicate* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  {
    &thumb_call_via_label[0],
    1 * (14),
    sizeof (thumb_call_via_label[0]),
    &gt_ggc_mx_rtx_def,
    &gt_pch_nx_rtx_def
  },
  {

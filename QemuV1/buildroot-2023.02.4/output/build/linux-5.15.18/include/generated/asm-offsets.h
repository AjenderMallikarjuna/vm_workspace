...
#define TSK_STACK_CANARY 496 /* offsetof(struct task_struct, stack_canary) */

#define TI_FLAGS 0 /* offsetof(struct thread_info, flags) */
#define TI_PREEMPT 4 /* offsetof(struct thread_info, preempt_count) */
#define TI_TASK 8 /* offsetof(struct thread_info, task) */
#define TI_CPU 12 /* offsetof(struct thread_info, cpu) */
#define TI_CPU_DOMAIN 16 /* offsetof(struct thread_info, cpu_domain) */
#define TI_CPU_SAVE 20 /* offsetof(struct thread_info, cpu_context) */
#define TI_ABI_SYSCALL 68 /* offsetof(struct thread_info, abi_syscall) */
#define TI_USED_CP 72 /* offsetof(struct thread_info, used_cp) */
#define TI_TP_VALUE 88 /* offsetof(struct thread_info, tp_value) */

...
.ascii "->OFF_pci_device_id_override_only #28 offsetof(struct pci_device_id, override_only)"	@
@ 0 "" 2
...
.ascii "->SIZE_rpmsg_device_id #36 sizeof(struct rpmsg_device_id)"	@
@ 0 "" 2
...
.ascii "->SIZE_auxiliary_device_id #36 sizeof(struct auxiliary_device_id)"	@
@ 0 "" 2
...
.ascii "->SIZE_ssam_device_id #12 sizeof(struct ssam_device_id)"	@
@ 0 "" 2
...
.ascii "->SIZE_dfl_device_id #8 sizeof(struct dfl_device_id)"	@
@ 0 "" 2
...
@ 0 "" 2
@ scripts/mod/devicetable-offsets.c:263: }
	.arm
	.syntax unified
	mov	r0, #0	@,
	bx	lr	@

cmd_drivers/hid/hid-quirks.o := /home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/bin/arm-buildroot-linux-gnueabi-gcc -Wp,-MMD,drivers/hid/.hid-quirks.o.d -nostdinc -isystem /home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/lib/gcc/arm-buildroot-linux-gnueabi/11.4.0/include -I./arch/arm/include -I./arch/arm/include/generated  -I./include -I./arch/arm/include/uapi -I./arch/arm/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -mlittle-endian -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -fno-dwarf2-cfi-asm -fno-ipa-sra -mabi=aapcs-linux -mfpu=vfp -funwind-tables -marm -Wa,-mno-warn-deprecated -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=arm9tdmi -msoft-float -Uarm -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-address-of-packed-member -O2 -fno-allow-store-data-races -Wframe-larger-than=1024 -fstack-protector-strong -Wimplicit-fallthrough=5 -Wno-main -Wno-unused-but-set-variable -Wno-unused-const-variable -fomit-frame-pointer -fno-stack-clash-protection -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -Wno-packed-not-aligned -Wno-attribute-alias    -DKBUILD_MODFILE='"drivers/hid/hid"' -DKBUILD_BASENAME='"hid_quirks"' -DKBUILD_MODNAME='"hid"' -D__KBUILD_MODNAME=kmod_hid -c -o drivers/hid/hid-quirks.o drivers/hid/hid-quirks.c

source_drivers/hid/hid-quirks.o := drivers/hid/hid-quirks.c

deps_drivers/hid/hid-quirks.o := \
    $(wildcard include/config/HID_A4TECH) \
    $(wildcard include/config/HID_ACCUTOUCH) \
    $(wildcard include/config/HID_ACRUX) \
    $(wildcard include/config/HID_ALPS) \
    $(wildcard include/config/HID_APPLE) \
    $(wildcard include/config/HID_APPLEIR) \
    $(wildcard include/config/HID_ASUS) \
    $(wildcard include/config/HID_AUREAL) \
    $(wildcard include/config/HID_BELKIN) \
    $(wildcard include/config/HID_BETOP_FF) \
    $(wildcard include/config/HID_CHERRY) \
    $(wildcard include/config/HID_CHICONY) \
    $(wildcard include/config/HID_CMEDIA) \
    $(wildcard include/config/HID_CORSAIR) \
    $(wildcard include/config/HID_CP2112) \
    $(wildcard include/config/HID_CYPRESS) \
    $(wildcard include/config/HID_DRAGONRISE) \
    $(wildcard include/config/HID_ELAN) \
    $(wildcard include/config/HID_ELECOM) \
    $(wildcard include/config/HID_ELO) \
    $(wildcard include/config/HID_EMS_FF) \
    $(wildcard include/config/HID_EZKEY) \
    $(wildcard include/config/HID_GEMBIRD) \
    $(wildcard include/config/HID_GFRM) \
    $(wildcard include/config/HID_GREENASIA) \
    $(wildcard include/config/HID_GT683R) \
    $(wildcard include/config/HID_GYRATION) \
    $(wildcard include/config/HID_HOLTEK) \
    $(wildcard include/config/HID_ICADE) \
    $(wildcard include/config/HID_JABRA) \
    $(wildcard include/config/HID_KENSINGTON) \
    $(wildcard include/config/HID_KEYTOUCH) \
    $(wildcard include/config/HID_KYE) \
    $(wildcard include/config/HID_LCPOWER) \
    $(wildcard include/config/HID_LENOVO) \
    $(wildcard include/config/HID_LOGITECH) \
    $(wildcard include/config/HID_LOGITECH_HIDPP) \
    $(wildcard include/config/HID_MAGICMOUSE) \
    $(wildcard include/config/HID_MAYFLASH) \
    $(wildcard include/config/HID_MICROSOFT) \
    $(wildcard include/config/HID_MONTEREY) \
    $(wildcard include/config/HID_MULTITOUCH) \
    $(wildcard include/config/HID_WIIMOTE) \
    $(wildcard include/config/HID_NTI) \
    $(wildcard include/config/HID_NTRIG) \
    $(wildcard include/config/HID_ORTEK) \
    $(wildcard include/config/HID_PANTHERLORD) \
    $(wildcard include/config/HID_PENMOUNT) \
    $(wildcard include/config/HID_PETALYNX) \
    $(wildcard include/config/HID_PICOLCD) \
    $(wildcard include/config/HID_PLANTRONICS) \
    $(wildcard include/config/HID_PRIMAX) \
    $(wildcard include/config/HID_PRODIKEYS) \
    $(wildcard include/config/HID_RETRODE) \
    $(wildcard include/config/HID_RMI) \
    $(wildcard include/config/HID_ROCCAT) \
    $(wildcard include/config/HID_SAITEK) \
    $(wildcard include/config/HID_SAMSUNG) \
    $(wildcard include/config/HID_SMARTJOYPLUS) \
    $(wildcard include/config/HID_SONY) \
    $(wildcard include/config/HID_SPEEDLINK) \
    $(wildcard include/config/HID_STEELSERIES) \
    $(wildcard include/config/HID_SUNPLUS) \
    $(wildcard include/config/HID_THRUSTMASTER) \
    $(wildcard include/config/HID_TIVO) \
    $(wildcard include/config/HID_TOPSEED) \
    $(wildcard include/config/HID_TWINHAN) \
    $(wildcard include/config/HID_UDRAW_PS3) \
    $(wildcard include/config/HID_XINMO) \
    $(wildcard include/config/HID_ZEROPLUS) \
    $(wildcard include/config/HID_ZYDACRON) \
    $(wildcard include/config/MOUSE_SYNAPTICS_USB) \
  ...
  include/linux/power_supply.h \
    ...
    $(wildcard include/config/POWER_SUPPLY_HWMON) \

...
#line 4 "/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/build/host-qemu-7.2.1/scsi/trace-events"
...
static inline void _nocheck__trace_pr_manager_run(int fd, int cmd, int sa)
{
    if (trace_event_get_state(TRACE_PR_MANAGER_RUN) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/build/host-qemu-7.2.1/scsi/trace-events"

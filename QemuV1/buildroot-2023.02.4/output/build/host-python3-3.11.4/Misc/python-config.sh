...
prefix_build="/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host"
...
CFLAGS=$(echo "-O2 -I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.11"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBPL=$(echo "$(prefix)/lib/python3.11/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu" | sed "s#^$prefix_build#$prefix_real#")

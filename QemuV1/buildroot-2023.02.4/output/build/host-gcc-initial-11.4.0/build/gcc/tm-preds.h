...
extern int const_1_to_4_operand (rtx, machine_mode);
extern int const_2_4_8_16_operand (rtx, machine_mode);
extern int alu_shift_operator_lsl_1_to_4 (rtx, machine_mode);
extern int alu_shift_reg_p (rtx, machine_mode);
extern int s_register_operand (rtx, machine_mode);
extern int mve_memory_operand (rtx, machine_mode);
extern int mve_scatter_memory (rtx, machine_mode);
extern int mve_imm_16 (rtx, machine_mode);
extern int mve_imm_7 (rtx, machine_mode);
extern int mve_imm_8 (rtx, machine_mode);
extern int mve_imm_15 (rtx, machine_mode);
extern int mve_imm_31 (rtx, machine_mode);
extern int mve_imm_32 (rtx, machine_mode);
extern int mve_imm_selective_upto_8 (rtx, machine_mode);
extern int guard_addr_operand (rtx, machine_mode);
extern int guard_operand (rtx, machine_mode);
extern int vpr_register_operand (rtx, machine_mode);
...
extern int arm_low_register_operand (rtx, machine_mode);
extern int arm_general_adddi_operand (rtx, machine_mode);
...
extern int const_int_coproc_operand (rtx, machine_mode);
extern int const_int_ccde1_operand (rtx, machine_mode);
extern int const_int_ccde2_operand (rtx, machine_mode);
extern int const_int_ccde3_operand (rtx, machine_mode);
extern int const_int_vcde1_operand (rtx, machine_mode);
extern int const_int_vcde2_operand (rtx, machine_mode);
extern int const_int_vcde3_operand (rtx, machine_mode);
extern int const_int_mve_cde1_operand (rtx, machine_mode);
extern int const_int_mve_cde2_operand (rtx, machine_mode);
extern int const_int_mve_cde3_operand (rtx, machine_mode);
extern int shift_amount_operand (rtx, machine_mode);
extern int const_neon_scalar_shift_amount_operand (rtx, machine_mode);
extern int ssat16_imm (rtx, machine_mode);
extern int usat16_imm (rtx, machine_mode);
...
extern int arm_anddi_operand (rtx, machine_mode);
extern int arm_iordi_operand (rtx, machine_mode);
...
extern int arm_adcimm_operand (rtx, machine_mode);
...
extern int long_shift_imm (rtx, machine_mode);
extern int arm_reg_or_long_shift_imm (rtx, machine_mode);
...
extern int arm_comparison_operator_mode (rtx, machine_mode);
extern int arm_comparison_operation (rtx, machine_mode);
extern int lt_ge_comparison_operator (rtx, machine_mode);
extern int arm_carry_operation (rtx, machine_mode);
extern int arm_borrow_operation (rtx, machine_mode);
...
extern int hard_sf_operand (rtx, machine_mode);
extern int hard_df_operand (rtx, machine_mode);
extern int clear_multiple_operation (rtx, machine_mode);
extern int clear_vfp_multiple_operation (rtx, machine_mode);
...
extern int mve_struct_operand (rtx, machine_mode);
...
extern int mve_vldrd_immediate (rtx, machine_mode);

...
const poly_uint16_pod mode_precision[NUM_MACHINE_MODES] = 
{
  ...
  { 4 * BITS_PER_UNIT },   /* CC_NV */
  { 4 * BITS_PER_UNIT },   /* CC_SWP */
  { 4 * BITS_PER_UNIT },   /* CC_RSB */
  ...
  { 4 * BITS_PER_UNIT },   /* V2BF */
  { 8 * BITS_PER_UNIT },   /* V4HF */
  { 8 * BITS_PER_UNIT },   /* V4BF */
  { 8 * BITS_PER_UNIT },   /* V2SF */
  { 16 * BITS_PER_UNIT },  /* V8HF */
  { 16 * BITS_PER_UNIT },  /* V8BF */
...
#define MODE_MASK(m)                          \
  ...
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_NV */
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_SWP */
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_RSB */
  ...
  MODE_MASK (4*BITS_PER_UNIT),   /* CC_B */
...
init_adjust_machine_modes (void)
{
  ...
  /* config/arm/arm-modes.def:82 */
  REAL_MODE_FORMAT (E_BFmode) = &arm_bfloat_half_format;

  /* config/arm/arm-modes.def:27 */

...
extern const struct ggc_root_tab gt_ggc_r_gt_c_family_c_cppbuiltin_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_c_family_c_pragma_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_c_family_c_format_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_call_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_class_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_constexpr_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_constraint_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_coroutines_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_cp_gimplify_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_cp_objcp_common_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_decl_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_decl2_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_except_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_friend_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_init_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_lambda_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_lex_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_mangle_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_method_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_cp_module_h[];
...
extern const struct ggc_root_tab gt_ggc_r_gt_cp_vtable_class_hierarchy_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_objc_objc_act_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_objc_objc_runtime_shared_support_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_objc_objc_gnu_runtime_abi_01_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_objc_objc_next_runtime_abi_01_h[];
extern const struct ggc_root_tab gt_ggc_r_gt_objc_objc_next_runtime_abi_02_h[];
EXPORTED_CONST struct ggc_root_tab * const gt_ggc_rtab[] = {
  ...
  gt_ggc_r_gt_c_family_c_cppbuiltin_h,
  gt_ggc_r_gt_c_family_c_pragma_h,
  gt_ggc_r_gt_c_family_c_format_h,
  gt_ggc_r_gt_cp_call_h,
  gt_ggc_r_gt_cp_class_h,
  gt_ggc_r_gt_cp_constexpr_h,
  gt_ggc_r_gt_cp_constraint_h,
  gt_ggc_r_gt_cp_coroutines_h,
  gt_ggc_r_gt_cp_cp_gimplify_h,
  gt_ggc_r_gt_cp_cp_objcp_common_h,
  gt_ggc_r_gt_cp_decl_h,
  gt_ggc_r_gt_cp_decl2_h,
  gt_ggc_r_gt_cp_except_h,
  gt_ggc_r_gt_cp_friend_h,
  gt_ggc_r_gt_cp_init_h,
  gt_ggc_r_gt_cp_lambda_h,
  gt_ggc_r_gt_cp_lex_h,
  gt_ggc_r_gt_cp_mangle_h,
  gt_ggc_r_gt_cp_method_h,
  gt_ggc_r_gt_cp_module_h,
  ...
  gt_ggc_r_gt_cp_vtable_class_hierarchy_h,
  gt_ggc_r_gt_objc_objc_act_h,
  gt_ggc_r_gt_objc_objc_runtime_shared_support_h,
  gt_ggc_r_gt_objc_objc_gnu_runtime_abi_01_h,
  gt_ggc_r_gt_objc_objc_next_runtime_abi_01_h,
  gt_ggc_r_gt_objc_objc_next_runtime_abi_02_h,
  NULL
};
...
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_class_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_constexpr_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_constraint_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_cp_gimplify_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_decl_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_logic_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_method_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_name_lookup_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_parser_h[];
extern const struct ggc_root_tab gt_ggc_rd_gt_cp_pt_h[];
EXPORTED_CONST struct ggc_root_tab * const gt_ggc_deletable_rtab[] = {
  ...
  gt_ggc_rd_gt_cp_constexpr_h,
  gt_ggc_rd_gt_cp_constraint_h,
  gt_ggc_rd_gt_cp_cp_gimplify_h,
  gt_ggc_rd_gt_cp_decl_h,
  gt_ggc_rd_gt_cp_logic_h,
  gt_ggc_rd_gt_cp_method_h,
  gt_ggc_rd_gt_cp_name_lookup_h,
  gt_ggc_rd_gt_cp_parser_h,
  gt_ggc_rd_gt_cp_pt_h,
  NULL
};
...
extern void gt_clear_caches_gt_cp_constraint_h ();
extern void gt_clear_caches_gt_cp_cp_objcp_common_h ();
extern void gt_clear_caches_gt_cp_decl_h ();
extern void gt_clear_caches_gt_cp_init_h ();
extern void gt_clear_caches_gt_cp_module_h ();
extern void gt_clear_caches_gt_cp_pt_h ();
void
gt_clear_caches ()
{
...
extern const struct ggc_root_tab gt_pch_rs_gt_c_family_c_cppbuiltin_h[];
extern const struct ggc_root_tab gt_pch_rs_gt_cp_cp_gimplify_h[];
extern const struct ggc_root_tab gt_pch_rs_gt_cp_decl_h[];
extern const struct ggc_root_tab gt_pch_rs_gt_cp_lambda_h[];
...
extern const struct ggc_root_tab gt_pch_rs_gt_objc_objc_runtime_shared_support_h[];
extern const struct ggc_root_tab gt_pch_rs_gt_objc_objc_gnu_runtime_abi_01_h[];
extern const struct ggc_root_tab gt_pch_rs_gt_objc_objc_next_runtime_abi_01_h[];
EXPORTED_CONST struct ggc_root_tab * const gt_pch_scalar_rtab[] = {
  ...
  gt_pch_rs_gt_c_family_c_cppbuiltin_h,
  gt_pch_rs_gt_cp_cp_gimplify_h,
  gt_pch_rs_gt_cp_decl_h,
  gt_pch_rs_gt_cp_lambda_h,
  ...
  gt_pch_rs_gt_objc_objc_runtime_shared_support_h,
  gt_pch_rs_gt_objc_objc_gnu_runtime_abi_01_h,
  gt_pch_rs_gt_objc_objc_next_runtime_abi_01_h,
  NULL
};

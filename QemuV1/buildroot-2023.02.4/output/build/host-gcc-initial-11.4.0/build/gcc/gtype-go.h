...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_go_h[] = {
  {
    &go_non_zero_struct,
    1,
    sizeof (go_non_zero_struct),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  LAST_GGC_ROOT_TAB
...
extern const struct ggc_root_tab gt_ggc_r_gt_go_go_lang_h[];
extern const struct ggc_root_tab gt_ggc_r_gtype_go_h[];

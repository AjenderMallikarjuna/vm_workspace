...
am_rel_srcdir='.'
am_top_srcdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/build/host-automake-1.16.5'
am_top_builddir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/build/host-automake-1.16.5'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/automake-1.16/am'
    am_automake_acdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/aclocal-1.16'
    am_bindir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/bin'
    am_datadir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share'
    am_docdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/doc/automake'
    am_pkgvdatadir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/automake-1.16'
    am_scriptdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/automake-1.16'
    am_system_acdir='/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/share/aclocal'
    ;;
  no)
...
MKDIR_P=${AM_TESTSUITE_MKDIR_P-'/usr/bin/mkdir -p'}
...
AM_TEST_RUNNER_SHELL=${AM_TEST_RUNNER_SHELL-'/bin/bash'}
...
# e.g., $SHELL=/bin/tcsh).
SHELL=${AM_TESTSUITE_SHELL-'/bin/bash'}; export SHELL
...
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  CC=${AM_TESTSUITE_CC-${CC-'/usr/bin/gcc'}}
else
  CC=$am_testaux_builddir/cc-no-c-o
fi
CXX=${AM_TESTSUITE_CXX-${CXX-'/usr/bin/g++'}}
F77=${AM_TESTSUITE_F77-${F77-'false'}}
FC=${AM_TESTSUITE_FC-${FC-'false'}}
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include'}}

# GNU compilers and their flags.
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/usr/bin/gcc'}}
else
  GNU_CC=$am_testaux_builddir/cc-no-c-o
fi
GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'/usr/bin/gcc'}}
GNU_CXX=${AM_TESTSUITE_GNU_CXX-${GNU_CXX-'/usr/bin/g++'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/ajender/QemuV1/Docker/buildroot-2023.02.4/output/host/include'}}
